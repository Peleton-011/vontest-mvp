...
onMounted(async () => {
  ...
  useTruncateText(text.value, textChild.value, 4, "show less.", "... show more");
});
  ...
  <div>
    <div v-if="false">
      <div>
        <p ref="test">
          <span ref="testChild"
            >Very long text should be truncate use js. Very long text should be
            truncate.Very long text should be truncate.Very long text should be
            truncate.Very long text should be truncate.Very long text should be
            truncate.Very long text should be truncate.Very long text should be truncate
            use js. Very long text should be truncate.Very long text should be
            truncate.Very long text should be truncate.Very long text should be
            truncate.Very long text should be truncate.Very long text should be
            truncate.Very long text should be truncate use js. Very long text should be
            truncate.Very long text should be truncate.Very long text should be
            truncate.Very long text should be truncate.Very long text should be
            truncate.Very long text should be truncate.Very long text should be truncate
            use js. Very long text should be truncate.Very long text should be
